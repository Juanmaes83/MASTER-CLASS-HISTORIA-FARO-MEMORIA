(()=>{
  ...
  const translations={
    en:{
      ...
      coastHead:['01 — THE COAST','WINDWARD APPROACH'],
      ...
      machineHead:['03 — THE MACHINE','FRESNEL / CLOCKWORK'],
    ...
    es:{
      ...
      coastHead:['01 — LA COSTA','APROXIMACIÓN A BARLOVENTO'],
      ...
      machineHead:['03 — LA MÁQUINA','FRESNEL / MECANISMO'],
  ...
  function applyLanguage(lang){
    ...
    const coastKs=qa('#coast .sec-head .k'); if(coastKs[0])coastKs[0].textContent=t.coastHead[0]; if(coastKs[1])coastKs[1].textContent=t.coastHead[1];
    set('#coast h2',t.coastTitle); set('#coast .lead',t.coastLead); set('#coast .body',t.coastBody); setMany('#coast .stats span',t.coastStats);
    const keeperKs=qa('#keeper .sec-head .k'); if(keeperKs[0])keeperKs[0].textContent=t.keeperHead;
    ...
    const machineKs=qa('#machine .sec-head .k'); if(machineKs[0])machineKs[0].textContent=t.machineHead[0]; if(machineKs[1])machineKs[1].textContent=t.machineHead[1];
